...
public class DBConnection extends javax.swing.JFrame {
	...
	public void TabloDoldur() {
		try {
			...
			JOptionPane.showConfirmDialog(null, "Baglantý basarýsýz", "MySQL Baglantý hatasý",
	...
	public void KayitEkle(String KategoriId, String ad, String Aciklama, String Fiyat) {
		try {
			...
			JOptionPane.showConfirmDialog(null, "Kayýt Eklenemedi", "MySQL Baglantý hatasý", JOptionPane.PLAIN_MESSAGE);
		}
	}
	...
	public void KayitSil(String ID) {
		try {
			...
			JOptionPane.showConfirmDialog(null, "Kayýt Silinemedi", "MySQL Baglantý hatasý", JOptionPane.PLAIN_MESSAGE);
		}
	}
	...
	public void KayitGuncelle(String ID, String ad, String soyad, String yas) {
		try {
			...
			JOptionPane.showConfirmDialog(null, "Kayýt guncellenemedi", "MySQL Baglantý hatasý",
					JOptionPane.PLAIN_MESSAGE);
		}
	}
	...
	private void initComponents() {
		...
		guncelleButton.setText("GÃ¼ncelle");
